...
| BL-DD-02 | 🔴 High | needs-design | `xlsx@0.18.5` (proto-pollution/ReDoS, no fix) bundled to browser (F10) | Replace the lib or isolate/remove the import feature (`admin.js:9`) |
