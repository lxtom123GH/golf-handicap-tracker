...
export function setupTabs() {
    ...
    try {
        ...
        if (footerVer) footerVer.textContent = 'v6.11.1 - Exit UX Highlight';
        if (headerVer) headerVer.textContent = 'v6.11.1 - Exit UX Highlight';
        console.log(`[UI] Version Injected: v6.11.1 - Exit UX Highlight`);
    } catch (e) {
