...
[1A[2K[2m[WebServer] [22m(node:92222) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
...
[1A[2K[chromium] › tests/logic-boundaries.spec.js:104:5 › Phase 2: Logic & Boundary Suite - Golf Math Constraints › Chip-in Validation: Explicitly verify that Putts = 0 is successfully accepted when Score > 0
[Worker 5] [Browser] LOG: [Dev] Connecting to Firebase Local Emulators...
...
[1A[2K  11) [chromium] › tests/ui-ergonomics.spec.js:40:5 › UI Ergonomics Suite › Live Scoring +/- buttons have touch target size >= 44x44 pixels
...
[1A[2K  12) [chromium] › tests/ui-ergonomics.spec.js:28:5 › UI Ergonomics Suite › WHS Handicap Database: Ensure no horizontal scrolling
