...
[1A[2K[1/14] [chromium] ΓÇ║ tests\logic-boundaries.spec.js:21:5 ΓÇ║ Phase 2: Logic & Boundary Suite - Golf Math Constraints ΓÇ║ Time Travel: Assert UI rejects future dates in round creation
[1A[2K[2/14] [chromium] ΓÇ║ tests\logic-boundaries.spec.js:41:5 ΓÇ║ Phase 2: Logic & Boundary Suite - Golf Math Constraints ΓÇ║ WHS Limits: Assert UI rejects handicaps < -10.0 or > 54.0
...
[1A[2K  1) [chromium] ΓÇ║ tests\logic-boundaries.spec.js:21:5 ΓÇ║ Phase 2: Logic & Boundary Suite - Golf Math Constraints ΓÇ║ Time Travel: Assert UI rejects future dates in round creation 

    Error: [2mexpect([22m[31mlocator[39m[2m).[22mtoBeHidden[2m([22m[2m)[22m failed

    Locator:  locator('#app-loading-cloak')
    Expected: hidden
    Received: visible
    Timeout:  5000ms
    ...
    [2m  - waiting for locator('#app-loading-cloak')[22m
    [2m    8 ├ù locator resolved to <div class="cloak-hidden" id="app-loading-cloak">ΓÇª</div>[22m
    [2m      - unexpected value "visible"[22m


       8 |
       9 |         // Wait for app cloak to disappear
    > 10 |         await expect(page.locator('#app-loading-cloak')).toBeHidden({ timeout: 5000 });
         |                                                          ^
      11 |
      12 |         // If auth overlay is visible, log in as mock user
      13 |         if (await page.locator('#auth-overlay').isVisible()) {
        at C:\Users\lxtom\.gemini\antigravity\scratch\golf_handicap_tracker\tests\logic-boundaries.spec.js:10:58

    Error Context: test-results\logic-boundaries-Phase-2-L-7e734-ure-dates-in-round-creation-chromium\error-context.md


[1A[2K  2) [chromium] ΓÇ║ tests\logic-boundaries.spec.js:41:5 ΓÇ║ Phase 2: Logic & Boundary Suite - Golf Math Constraints ΓÇ║ WHS Limits: Assert UI rejects handicaps < -10.0 or > 54.0 
    ...
    [2m  - Expect "toBeHidden" with timeout 5000ms[22m
    [2m  - waiting for locator('#app-loading-cloak')[22m
    [2m    9 ├ù locator resolved to <div class="cloak-hidden" id="app-loading-cloak">ΓÇª</div>[22m
    [2m      - unexpected value "visible"[22m
...
[1A[2K  3) [chromium] ΓÇ║ tests\async-coach.spec.js:5:5 ΓÇ║ Phase 5: Multi-Context Interaction Suite ΓÇ║ Simulate Real-time Coaching: Player A connects -> Coach B gets notify 
    ...
    [2m      - unexpected value "visible"[22m
      ...
      16 |
      17 |         // 1. Player A logic (login, practice)
    > 18 |         await expect(playerPage.locator('#app-loading-cloak')).toBeHidden({ timeout: 5000 });
         |                                                                ^
      19 |         if (await playerPage.locator('#auth-overlay').isVisible()) {
      20 |             await playerPage.fill('#auth-email', 'playerA@example.com');
      21 |             await playerPage.fill('#auth-password', 'password123');
        at C:\Users\lxtom\.gemini\antigravity\scratch\golf_handicap_tracker\tests\async-coach.spec.js:18:64
...
[1A[2K  4) [chromium] ΓÇ║ tests\logic-boundaries.spec.js:58:5 ΓÇ║ Phase 2: Logic & Boundary Suite - Golf Math Constraints ΓÇ║ Fuzzing Scores: Assert UI rejects scores <= 0 and >= 20 for a single hole 
...
[1A[2K  5) [chromium] ΓÇ║ tests\logic-boundaries.spec.js:79:5 ΓÇ║ Phase 2: Logic & Boundary Suite - Golf Math Constraints ΓÇ║ Sub-Score Logic: Assert UI throws an error if Putts > Total Score or Penalties >= Total Score 
...
[1A[2K  6) [chromium] ΓÇ║ tests\logic-boundaries.spec.js:83:5 ΓÇ║ Phase 2: Logic & Boundary Suite - Golf Math Constraints ΓÇ║ Chip-in Validation: Explicitly verify that Putts = 0 is successfully accepted when Score > 0 
...
[1A[2K  7) [chromium] ΓÇ║ tests\quota-guards.spec.js:16:5 ΓÇ║ Phase 3: Infrastructure & Quota Suite ΓÇ║ The Double-Tap: Simulate rapid multi-clicks (5 in 1 sec) on "Generate AI Briefing" 
    ...
    [2m      - unexpected value "visible"[22m
       ...
       6 |         await page.goto('/');
    >  7 |         await expect(page.locator('#app-loading-cloak')).toBeHidden({ timeout: 5000 });
         |                                                          ^
       8 |         if (await page.locator('#auth-overlay').isVisible()) {
       9 |             await page.fill('#auth-email', 'test@example.com');
      10 |             await page.fill('#auth-password', 'password123');
        at C:\Users\lxtom\.gemini\antigravity\scratch\golf_handicap_tracker\tests\quota-guards.spec.js:7:58

    Error Context: test-results\quota-guards-Phase-3-Infra-4d687-ec-on-Generate-AI-Briefing--chromium\error-context.md


[1A[2K  8) [chromium] ΓÇ║ tests\quota-guards.spec.js:44:5 ΓÇ║ Phase 3: Infrastructure & Quota Suite ΓÇ║ Cache Hit Check: Request practice drill when active one exists local state 
...
[1A[2K  9) [chromium] ΓÇ║ tests\security-rbac.spec.js:16:5 ΓÇ║ Phase 4: Security & RBAC Suite ΓÇ║ The Peeping Tom: Assert standard Player navigating to /coach-dashboard is instantly redirected 
    ...
    >  7 |         await expect(page.locator('#app-loading-cloak')).toBeHidden({ timeout: 5000 });
       ...
       9 |             await page.fill('#auth-email', 'test@example.com');
      10 |             await page.fill('#auth-password', 'password123');
        at C:\Users\lxtom\.gemini\antigravity\scratch\golf_handicap_tracker\tests\security-rbac.spec.js:7:58
...
[1A[2K  10) [chromium] ΓÇ║ tests\security-rbac.spec.js:36:5 ΓÇ║ Phase 4: Security & RBAC Suite ΓÇ║ Data Isolation: Assert Firestore Security Rules block Player B from reading Player A unshared round ID 
...
[1A[2K  11) [chromium] ΓÇ║ tests\ui-ergonomics.spec.js:16:5 ΓÇ║ UI Ergonomics Suite ΓÇ║ WHS Handicap Database: Ensure no horizontal scrolling 
    ...
    >  7 |         await expect(page.locator('#app-loading-cloak')).toBeHidden({ timeout: 5000 });
       ...
       9 |             await page.fill('#auth-email', 'test@example.com');
      10 |             await page.fill('#auth-password', 'password123');
        at C:\Users\lxtom\.gemini\antigravity\scratch\golf_handicap_tracker\tests\ui-ergonomics.spec.js:7:58
...
[1A[2K  12) [chromium] ΓÇ║ tests\ui-ergonomics.spec.js:28:5 ΓÇ║ UI Ergonomics Suite ΓÇ║ Live Scoring +/- buttons have touch target size >= 44x44 pixels 
...
[1A[2K  13) [chromium] ΓÇ║ tests\ui-ergonomics.spec.js:48:5 ΓÇ║ UI Ergonomics Suite ΓÇ║ Add Club modal tag-balance check does not swallow main-app 
...
[1A[2K  14) [chromium] ΓÇ║ tests\ux-bag-management.spec.js:16:5 ΓÇ║ UX State Persistence Suite: Bag Management ΓÇ║ Add/Remove custom club, assert persistence across reload, and assert in Live Scoring detailed stats 
    ...
    >  7 |         await expect(page.locator('#app-loading-cloak')).toBeHidden({ timeout: 5000 });
       ...
       9 |             await page.fill('#auth-email', 'test@example.com');
      10 |             await page.fill('#auth-password', 'password123');
        at C:\Users\lxtom\.gemini\antigravity\scratch\golf_handicap_tracker\tests\ux-bag-management.spec.js:7:58
